...
If you already have R on your computer and it is older than the most recent version, see instructions [here](https://dyerlab.org/posts/2013-06-03-updating-r-and-with-current-libraries/updating-r-and-with-current-libraries.html) on how to update the libraries you currently have loaded.


## Continue Doing Right Now
...
We will be using [GitHub](https://github.com) continuously throughout this class.   
