---
title: "Welcome to ENVS 543"
subtitle: "Circumscribing the Landscape"
...
A philosophical approach to curriculum design that begins wiht the end in mind.

- Identify desired results,   
- Determine acceptable evidence of learning, and  
- Plan the learning objective 

## Learning Objectives


![](media/LearningObjectives.png)
...
[Install R](https://cran.r-project.org){preview-link="true" style="text-align: center"} onto your laptop (version 4.3+).
...
[Install RStudio](https://www.rstudio.com/products/rstudio/download/#download){preview-link="true" style="text-align: center"}---the "One True Interface" (`2024.04.2-764` or later).
